...
lambda str, outputStr: str.lower() in outputStr.lower()  , # output contains input ignoring case?
lambda str, outputStr: outputStr.lower().startswith(str.lower()), # output starts with input ignoring case?
lambda str, outputStr: outputStr.lower().endswith(str.lower())  , # output ends with input ignoring case?
lambda str, outputStr: outputStr.lower() in str.lower()         , # input contains output ignoring case?
lambda str, outputStr: str.lower().startswith(outputStr.lower()) , # input starts with output ignoring case?
lambda str, outputStr: str.lower().endswith(outputStr.lower())   , # input ends with output ignoring case?
lambda str, outputStr: str == outputStr                   , # input equals output?
lambda str, outputStr: str.lower() == outputStr.lower()   , # input equals output ignoring case?
lambda str, outputStr: len(str) == len(outputStr)         , # input same length as output?
...
lambda integer, outputStr: integer == len(outputStr)         , # is equal to output length?
lambda integer, outputStr: integer >= len(outputStr)         , # is greater or equal to output length?
lambda integer, outputStr: integer > len(outputStr)          , # is greater than output length?
